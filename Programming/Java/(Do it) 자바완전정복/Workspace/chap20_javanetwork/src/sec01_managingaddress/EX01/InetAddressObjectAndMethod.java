package sec01_managingaddress.EX01;
...
public class InetAddressObjectAndMethod {
	public static void main(String[] args) throws IOException {
		...
		InetAddress ia2 = InetAddress.getByAddress(new byte[] {(byte)172, (byte)217, (byte)26, (byte)228});
		InetAddress ia3 = InetAddress.getByAddress("www.google.com", new byte[] {(byte)172, (byte)217, (byte)26, (byte)228});
		...
		//#2. InetAddress 메서드
		byte[] address = ia1.getAddress();	//getHostAddress() 사용 권고
		...
		System.out.println(ia1.isMulticastAddress());	//false, D class : 224-239.0-255,0-255,0-255
