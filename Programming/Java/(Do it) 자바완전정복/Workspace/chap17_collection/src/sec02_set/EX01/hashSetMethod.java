...
public class hashSetMethod {
	public static void main(String[] args) {
		...
		hSet2.add("다");
		hSet2.addAll(hSet1);
		System.out.println(hSet2.toString());	//[나 다 가] - 출력 순서는 입력 순서와 일치하지 않음
		
		//#3. remove(Object o)
		hSet2.remove("나");
		System.out.println(hSet2.toString());	//[가 다] - 출력 순서는 입력 순서와 일치하지 않음
		...
		System.out.println(hSet3.contains("라")); //flase
