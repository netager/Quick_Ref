...
public class HashTableMethod {
	public static void main(String[] args) {
		...
		//#11-1. remove(Object key)			
		hTable2.remove(1);
		hTable2.remove(4);
		System.out.println(hTable2.toString()); 	//{2=나다라, 3=다라마}
		
		//#12. remove(Object key, Object values)			
