...
public class LinkedHashMapMethod {
	public static void main(String[] args) {
		...
		System.out.println(keySet.toString());				// [2, 1, 3] - 순서없음
		
		
		//#9. Set<Map.Entry<K, V> entrySet()
		Set<Map.Entry<Integer, String>> entrySet = lhMap2.entrySet();
		System.out.println(entrySet.toString()); 		//[2=나다라, 1=나나나, 3=다라마] - 순서없음
		System.out.println(lhMap2.toString());			//[2=나다라, 1=나나나, 3=다라마] - 순서없음
