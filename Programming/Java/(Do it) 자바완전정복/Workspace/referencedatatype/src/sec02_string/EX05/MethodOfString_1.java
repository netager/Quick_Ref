...
public class MethodOfString_1 {
	public static void main(String[] args) {
		...
		System.out.println(str1.indexOf('a', 8)); // 8번위치부터 시작해서 오른쪽으로 a를 찾아라
		System.out.println(str1.lastIndexOf('a', 8)); //8번위치에서부터 시작해서 왼쪽으로 a를 찾아라
		...
		System.out.println(str1.indexOf("Bye")); 		// 찾지 못하면 -1
