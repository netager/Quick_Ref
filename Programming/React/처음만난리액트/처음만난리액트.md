...
#### 명령어
- npm start     // react application start


## 03강. JSX

### JSX 개념 - JavaScript & XML
...
### JSX의 역할
- React.createElement(     // jsx 코드를 javascript로 변환
    type,
    [props],
    [...children]
)
...
class Hello extends React.Component {
    render() {
        return React.createElement('dev', null, `Hello ${this.props.toWhat}`);
    }
}
...
- 가독성 향상
- 버그를 발견하기 쉬움!
- Injection Attacks 방어(XSS)

### JSX 사용법
- 


## 04강. Rendering Elements
